...
app.post('/articles', (request, response) => {
  client.query(
    ...
    function(err) {
      ...
      // DONE: This is our second query, to be executed when this first query is complete.
      queryTwo();
    }
  )
  ...
  function queryTwo() {
    client.query(
      ...
      function(err, result) {
        ...
        // DONE: This is our third query, to be executed when the second is complete. We are also passing the author_id into our third query.
  ...
  function queryThree(author_id) {
    client.query(
      ...
      VALUES ($1, $2, $3, $4, $5);`,
      [request.body.title, request.body.category, request.body.publishedOn, request.body.body, author_id],
      function(err) {
        if (err) console.error(err);
